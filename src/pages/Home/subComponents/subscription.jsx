...
const Subscription = () => {
  ...
  return (
    <Container className="md:py-[80px] md:px-[150px] p-10 text-left">
      <div className="flex flex-col gap-4">
        ...
        <div className="w-[100%] md:w-[360px] flex items-center justify-between rounded-xl shadow-xl p-2 border-1 bg-[#5f58ec67] mt-5">
